...
(function() {
  ...
  NamedLock = (function(_super) {
    ...
    NamedLock.prototype.release = function() {
      if (this.decref() === 0) {
        delete this.tab.locks["delete"](this.name);
      }
      return NamedLock.__super__.release.call(this);
    };
  ...
  exports.SingleFlightTable = SingleFlightTable = (function() {
    ...
    SingleFlightTable.prototype._create = function(_arg) {
      var key, ret;
      key = _arg.key;
      ret = new SingleFlighter({
        table: this,
        key: key
      });
      this._jobs.set(key, ret);
      return ret;
    };
    ...
    SingleFlightTable.prototype.enter = function(_arg, cb) {
      ...
      s = this._jobs.get(key) || this._create({
        key: key
      });
      s._incref();
      return s._enter({
